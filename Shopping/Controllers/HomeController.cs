...
namespace Shopping.Controllers
{
    public class HomeController : Controller
    {
        ...
        private async Task<IActionResult> Details1(int? id)
        {
            if (id == null)
            {
                return NotFound();
            ...
            AddProductToCartViewModel model = new AddProductToCartViewModel
            {
        ...
        private async Task<IActionResult> ShowCart1(ShowCartViewModel model)
        {
            User user = await _userHelper.GetUserAsync(User.Identity.Name);
            if (user == null)
            {
        ...
        private async Task<IActionResult> IncreaseQuantity(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        private async Task<IActionResult> Edit1(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        private IActionResult OrderSuccess()
        {
            return View();
        }

        private async Task<IActionResult> Edit(int id, EditTemporalSaleViewModel model)
        {
            if (id != model.Id)
            {
                return NotFound();
        ...
        private async Task<IActionResult> DecreaseQuantity(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        private async Task<IActionResult> ShowCart()
        {
            User user = await _userHelper.GetUserAsync(User.Identity.Name);
            if (user == null)
            {
        ...
        private async Task<IActionResult> Details(AddProductToCartViewModel model)
        {
        ...
        private async Task<IActionResult> Add(int? id)
        {
            if (id == null)
            {
                return NotFound();
